...
def welcome(message):
	...
	bot.send_message(message.chat.id, "Welcome, {0.first_name}! If you are here, it means that you are looking for a perfect QA match. Please first tap on '🔎 Find the 🔝 QA'".format(message.from_user, bot.get_me()),
